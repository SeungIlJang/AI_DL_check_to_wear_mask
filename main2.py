...
gender_net = cv2.dnn.readNetFromCaffe('models/gender/deploy_gender.prototxt', 'models/gender/gender_net.caffemodel')
age_net = cv2.dnn.readNetFromCaffe('models/age/deploy_age.prototxt', 'models/age/age_net.caffemodel')
